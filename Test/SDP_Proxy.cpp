...
{
    // 向controller发起SPA请求
    // SPAProxyClient client("121.248.51.112", 8881);
    ...
    // // 向controller发起TLS请求
    TLSProxyClient tlsClient("121.248.2.202", 7000);
    ...
    while (true)
    {
        ...
        std::cout << "receive response: " << std::string(response.begin(), response.end()) << std::endl;
    }
