...
function init_check {
    ...
    if [[ -z $res ]]; then
        echo -e "\033[31m-[-] /tmp/ not mounted on separate disk\033[0m"
        tmpIfSeparate="False"
        tmpIfNoexec="False"
        tmpIfNosuid="False"
    else
...
check_result={\"os_scan_result\":$os_scan_result,\"vuln_scan_result\":$vuln_scan_result}
#echo "==========================Saving Check Result======================"
echo $check_result > linux/linux_res.json
